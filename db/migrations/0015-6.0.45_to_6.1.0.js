	...
	exports.up = function(db, next) {
		...
		*/
			...
			db.collection("configs").update({"_id":"5a716a0eff6ae751f2dcaa39"}, {"$set":{"updatedAt":"2018-07-25T13:49:55.673Z"}}, {});
	...
	exports.down = function(db, next) {
			...
			collection.update({"_id":"5a716a0eff6ae751f2dcaa39"}, {"$unset":{"updatedAt":"2018-07-25T13:49:55.673Z"}}, {});
			
			db.collection("configs").update({"_id":"5a716a0eff6ae751f2dcaa39"}, {"$set":{"Name33":"layout_config33"}}, {});
			...
			*/
			...
			db.collection("configs").remove({_id : { $in : ["5a377d7dff6ae751f2542a32","5a50a483ff6ae751f29073f1","5a50a775ff6ae751f2907a4d"] }}, { justOne: true });
