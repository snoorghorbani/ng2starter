(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/flex-layout'), require('@angular/platform-browser/animations'), require('@angular/material'), require('rxjs/Rx'), require('@angular/forms'), require('@angular/common/http'), require('rxjs/BehaviorSubject'), require('@ngrx/store'), require('rxjs'), require('rxjs/Observable'), require('@ngrx/effects'), require('rxjs/observable/of'), require('@angular/router'), require('@angular/core'), require('rxjs/operators')) :
    ...
    (factory((global.soushians = global.soushians || {}, global.soushians.diagram = {}),global.ng.common,global.ng['flex-layout'],global.ng.platformBrowser.animations,global.ng.material,global.rxjs.Rx,global.ng.forms,global.ng.common.http,global.rxjs.BehaviorSubject,global.i2,global.rxjs,global.rxjs.Observable,global.effects,global.rxjs['observable/of'],global.ng.router,global.ng.core,global.rxjs.operators));
}(this, (function (exports,common,flexLayout,animations,material,Rx,forms,i1,BehaviorSubject,i2,rxjs,Observable,effects,of,router,i0,operators) { 'use strict';
