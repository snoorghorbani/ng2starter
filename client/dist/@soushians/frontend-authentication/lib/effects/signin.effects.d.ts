...
export declare class SigninEffects {
    ...
    private bottomSheet;
    constructor(actions$: Actions, router: Router, signinService: SigninService, configurationService: FrontendAuthenticationConfigurationService, bottomSheet: MatBottomSheet);
