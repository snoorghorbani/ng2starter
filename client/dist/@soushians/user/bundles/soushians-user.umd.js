    ...
    ***************************************************************************** */
    ...
    var UserService = (function () {
         ...
         */
            function () {
                var _this = this;
                return this.configurationService.config$.pipe(operators.filter(function (config$$1) { return config$$1.endpoints.profileInformation != ""; }), operators.take(1), operators.combineLatest(this.store.select(function (s) {
                    debugger;
                    return authentication.getUser(s);
