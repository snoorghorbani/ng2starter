...
export { NgsLayoutMainComponent as ɵi } from './lib/dumb-components/main/main.component';
...
export { LayoutEffects as ɵm } from './lib/layout.effects';
export { FeatureState as ɵb } from './lib/reducers';
export { LayoutReducers as ɵj } from './lib/reducers/index';
export { Reducer as ɵk } from './lib/reducers/layout.reducer';
export { Reducer as ɵl } from './lib/reducers/toolbar.reducer';
