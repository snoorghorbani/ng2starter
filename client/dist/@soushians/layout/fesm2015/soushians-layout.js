...
class ToolbarMenuComponent {
    ...
    constructor(document, _location, store, configurationService) {
        ...
        fromEvent(this.document.body, "scroll").subscribe(() => {
            const /** @type {?} */ scrolledAmount = this.document.body.scrollTop;
            const /** @type {?} */ scrollToTop = scrolledAmount - this.lastScroll < 0 && this.document.body.scrollHeight - scrolledAmount < 300;
