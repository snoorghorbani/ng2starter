...
var LayoutModuleConfigComponent = /** @class */ (function () {
    ...
    function (item) {
        debugger;
        var /** @type {?} */ index = (/** @type {?} */ (this.formGroup.get("menuItems"))).controls.indexOf(item);
