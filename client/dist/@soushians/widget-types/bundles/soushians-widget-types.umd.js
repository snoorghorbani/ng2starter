(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@ngrx/store'), require('@soushians/widget'), require('@soushians/frontend-authentication'), require('@angular/common'), require('@angular/router'), require('@angular/material'), require('angular-froala-wysiwyg')) :
    typeof define === 'function' && define.amd ? define('@soushians/widget-types', ['exports', '@angular/core', '@angular/forms', '@ngrx/store', '@soushians/widget', '@soushians/frontend-authentication', '@angular/common', '@angular/router', '@angular/material', 'angular-froala-wysiwyg'], factory) :
    (factory((global.soushians = global.soushians || {}, global.soushians['widget-types'] = {}),global.ng.core,global.ng.forms,null,null,null,global.ng.common,global.ng.router,global.ng.material,null));
}(this, (function (exports,core,forms,store,widget,frontendAuthentication,common,router,material,angularFroalaWysiwyg) { 'use strict';
